...
const PrivacyPolicy = () => {
    ...
    return {
      ...
      "@graph": [
        // PRIVACY POLICY WEBPAGE
        {
          ...
          name: "Privacy Policy - StarMe",
          description:
            "Read StarMe’s Privacy Policy to understand how we collect, use, store, and protect your personal information while using our personalized storybook services.",
        ...
        {
          "@type": "Legislation",
          "@id": `${baseUrl}/privacy-policy#legislation`,
          name: "StarMe Privacy Policy",
          description:
            "Privacy Policy explaining how StarMe collects, processes, and secures personal data for its personalized storybook services.",
          legislationType: "PrivacyPolicy",
          provider: {
        ...
        {
          "@type": "WebPage",
          "@id": `${baseUrl}/privacy-policy#speakable`,
          speakable: {
            "@type": "SpeakableSpecification",
            cssSelector: ["h1", "h2", ".text-[16px]"],
          },
        },
      ],
    };
  ...
  return (
    <>
      <GeoHelmet
        title="Privacy Policy - StarMe"
        description="Learn how StarMe collects, uses, and protects your personal information when using our personalized storybook services. Review data usage, cookies, security, and user rights."
        keywords="privacy policy, starme privacy, data protection, cookies policy, children's privacy, personal data usage, user data rights"
        type="website"
        schema={createPrivacySchema()}
      />
      <Navbar />
      <div className={` ${isNavbarOpen ? "blur-sm" : ""}  `}>
        <div className="bg-white min-h-screen">
          <div className="max-w-7xl mx-auto px-4   py-2">
            <div className="space-y-3 text-black text-[16px] font-figTree   leading-relaxed">
              <h1 className="text-[16px] font-figTree   font-normal">
                Privacy Policy
              </h1>

              <p className="text-[16px] font-figTree  ">
              ...
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Wonderwrapz
                LLC, Priceton.
              </p>
              ...
              <p>By email: support@starme.com</p>
            </div>
          </div>
        </div>
      </div>
