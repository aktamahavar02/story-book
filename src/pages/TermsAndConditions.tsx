...
const TermsAndConditions = () => {
   ...
   const createTermsSchema = () => {
    ...
    return {
      ...
      "@graph": [
        ...
        {
          "@type": "WebPage",
          "@id": `${baseUrl}/terms-and-conditions#webpage`,
          url: `${baseUrl}/terms-and-conditions`,
          name: "Terms and Conditions - StarMe ",
          description:
            "Read the official Terms & Conditions for using StarMe's personalized storybook services, including user responsibilities, policies, disclaimers, and legal guidelines.",
          ...
          //   cssSelector: ["terms-title", "terms-content"],
          // },
        },
        ...
        {
          "@type": "Legislation",
          "@id": `${baseUrl}/terms-and-conditions#legislation`,
          name: "StarMe Terms and Conditions",
          description:
            "Legal terms governing the use of StarMe personalized storybook services.",
        ...
        {
          "@type": "BreadcrumbList",
          "@id": `${baseUrl}/terms-and-conditions#breadcrumb`,
          itemListElement: [
            {
              "@type": "ListItem",
              position: 1,
        ...
        // ORGANIZATION
        {
          ...
          description:
            "StarMe creates personalized children's storybooks where your child becomes the hero.",
          contactPoint: {
            "@type": "ContactPoint",
  ...
  <GeoHelmet
  title="Terms & Conditions - StarMe "
  description="Review the Terms & Conditions for using StarMe's personalized storybook service, including user rights, responsibilities, privacy, and legal guidelines."
  keywords="terms and conditions, starme terms, legal terms, user agreement, policies"
  type="website"
  schema={createTermsSchema()}
/>
      <Navbar />
      </div>      <div className={` ${isNavbarOpen ? "blur-sm": ''}  `}>      
      <div className="bg-white min-h-screen">
        <div className="max-w-7xl mx-auto px-4  py-2 ">
          <div className="space-y-3 text-black text-[16px] font-figTree leading-relaxed terms-content">
            <h1 className="text-[16px] font-figTree font-normal terms-title">Terms and Conditions</h1>

            <p className="text-[16px] font-figTree  ">Last updated: October 08, 2024</p>
            ...
            <h2 className="text-[16px] font-figTree   font-normal">
              Interpretation and Definitions
            </h2>

            <h3 className="text-[16px] font-figTree   font-normal">Interpretation</h3>
            ...
            <h3 className="text-[16px] font-figTree   font-normal">Definitions</h3>
            ...
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Wonderwrapz LLC,
              Priceton.
            </p>
            ...
            <p>
              <strong>Website</strong> refers to Wonderwrapz, accessible from
              https://starmebooks.com
            </p>
            ...
            <h3 className="text-[16px] font-figTree   font-normal">
            ...
            <h4 className="text-[16px] font-figTree   font-normal">
            ...
            <p>
              ...
              immediately. Limitation of Liability
            </p>
            <p>
            ...
            <p>By email: support@starmebooks.com</p>
          </div>
        </div>
      </div>
      </div>
